...
if (isset($_POST['submit'])) {
    ...
    // Sélectionnez les informations de l'utilisateur actuel
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-silver">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                <?php 
                    if (isset($_SESSION['valid'])) {
                        echo "<li class='nav-item nav-item-bordered'><a class='nav-link' href='home.php'><b>Accueil</b></a></li>";
                        echo "<li class='nav-item nav-item-bordered'><a class='nav-link' href='mes_tickets.php'><b>Mes Tickets</b></a></li>";
